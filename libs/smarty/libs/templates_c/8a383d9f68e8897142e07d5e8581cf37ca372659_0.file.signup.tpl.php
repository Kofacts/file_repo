...
</h1> </div> <div class="modal-body"> <div class="form-group"> <b class="col-sm-offset-2 col-sm-10 text-right text-danger"><?php if (isset($_smarty_tpl->tpl_vars['errors']->value['username'])) {
...
}?>" placeholder="Enter your username here"> <span class="help-block">[3-20 characters]</span> </div> </div> <div class="form-group"> <b class="col-sm-offset-2 col-sm-10 text-right text-danger"><?php if (isset($_smarty_tpl->tpl_vars['errors']->value['password'])) {
...
}?>" placeholder="Enter your password here"> <p class="pull-left help-block">[6-50 characters]</p> <label class="pull-right"><input type="checkbox"> Show</label> </div> </div> <div class="form-group"> <b class="col-sm-offset-2 col-sm-10 text-right text-danger"><?php if (isset($_smarty_tpl->tpl_vars['errors']->value['email_address'])) {
...
}?>" placeholder="Enter your email address here"> <p class="help-block">[5-50 characters]</p> </div> </div> <div class="form-group"> <b class="col-sm-offset-2 col-sm-10 text-right text-danger"><?php if (isset($_smarty_tpl->tpl_vars['errors']->value['phone_number'])) {
...
}?>" placeholder="Enter your phone number here"> <p class="help-block">[5-20 characters]</p> </div> </div> </div> <div class="modal-footer"> <div class="col-sm-offset-2 col-sm-10"> <button class="btn btn-primary" type="submit">Submit</button> </div> </div> </div> </form> </div> </div> </div><?php
}
/* {/block 'body'} */
}
